...
const {data: statsFetch} = await useFetch('/api/stats')
const stats = ref(statsFetch)
...
const showPosts = useState('showPosts', () => true)
</script>
  ...
  <div class="app"> 
    <main class="main-content">
      <section class="profile">
        ...
        <!-- Posts -->
        <PostList :posts="posts" @select-post="openPost" v-if="showPosts"/>
